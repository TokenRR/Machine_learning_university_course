...
#4
#висновки
print('У першії моделі метрики вищі ніж у другої, а також краща точність. Проте у другої моделі більше площа під ROC кривою.\n'
      'Я більш схиляюся до 1ї моделі')


print('\nЗавдання 5')
#5
df_1 = df[df['GT'] == 1].sample(frac=0.5)
df_5aufgabe = df.drop(labels =df_1.index ,axis = 0)
print('Мій місяць 8. Тому прибираємо 50 %')
...
print('\nЗавдання 8')
#8
print('Модель 1 краща')


print('\nЗавдання 9')
#9
print('Там де вибірка менш збалансовама має сенс дивитися на PR криву, а вона більше у другої моделі \n'
      'Проте інші показники вищі у першої, к тому ж різниця під кривою не така ж і велика, тому я схиляюсь до того що перша краща')
